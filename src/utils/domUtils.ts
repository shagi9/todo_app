...
const createInput = (type: string, className: string, value: string | boolean, dataId: number): HTMLInputElement => {
...
export const createTodoItem = (todo: TodoModel): HTMLLIElement => {
